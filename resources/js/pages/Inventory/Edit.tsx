...
export default function EditProduct({ auth, product, categories }: EditProductProps) {
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update the details for this product in your inventory.
              </CardDescription>
            </CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <FormItem>
                        ...
                        <FormDescription>
                          Changing this will create a stock movement record
                        </FormDescription>
